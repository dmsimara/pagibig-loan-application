...
import com.mycompany.pagibigapplication.services.LoanApplicationService;
...
public class LoanParticular extends javax.swing.JFrame {
    ...
    public LoanParticular(AuthService authService) {
    ...
    private void addCustomComponents() {
        ...
        JLabel applicationLabel = new JLabel("Loan Particular");
        ...
        // table for data
        String[] columns = {
            "housingAccountNo", "purposeOfLoan", "hasExistingApplication", "housingApplicationNo", "loanAmount", "loanTerm", "repricingPeriod", "modeOfPayment", "pagibigMid"
        };
        ...
        try {
            ...
            LoanApplicationService loanAppService = new LoanApplicationService(conn);
            List<LoanApplication> apps = loanAppService.getAllLoanApplications();
            for (LoanApplication app : apps) {
                model.addRow(new Object[]{
                    app.getHousingAccountNo(),
                    app.getPurposeOfLoan(),
                    app.hasExistingApplication(),
                    app.getHousingApplicationNo(),
                    app.getLoanAmount(),
                    app.getLoanTerm(),
                    app.getRepricingPeriod(),
                    app.getModeOfPayment(),
                    app.getPagibigMid()
                });
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoanParticular(new AuthService()).setVisible(true);
            }
        });
    }
