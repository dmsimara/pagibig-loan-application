...
import com.mycompany.pagibigapplication.services.CollateralService;
...
public class CollateralPage extends javax.swing.JFrame {
    ...
    private void addCustomComponents() {
        ...
        JLabel applicationLabel = new JLabel("Collateral");
        ...
        // table for data
        String[] columns = {
            "tctOctCctNo", "primaryPropertyLocation", "propertyType", "developerTitleHolder", 
                "descriptionOfImprovements", "taxDeclarationNo", "lotUnitNo", "blockBuildingNo", 
                "numberOfStoreys", "isPropertyMortgaged", "landAreaSqm", "floorAreaSqm",
                "ageOfHouse", "totalFloorAreaSqm", "isOffsiteCollateral", "offsiteCollateralReason", "housingAccountNo"
        };
        ...
        columnModel.getColumn(0).setPreferredWidth(120);   // tctOctCctNo
        columnModel.getColumn(1).setPreferredWidth(180);   // primaryPropertyLocation
        columnModel.getColumn(2).setPreferredWidth(150);   // propertyType
        columnModel.getColumn(3).setPreferredWidth(150);   // developerTitleHolder
        columnModel.getColumn(4).setPreferredWidth(120);   // descriptionOfImprovements
        columnModel.getColumn(5).setPreferredWidth(100);   // taxDeclarationNo
        columnModel.getColumn(6).setPreferredWidth(100);   // lotUnitNo
        columnModel.getColumn(7).setPreferredWidth(150);   // blockBuildingNo
        columnModel.getColumn(8).setPreferredWidth(100);   // numberOfStoreys
        columnModel.getColumn(9).setPreferredWidth(120);   // isPropertyMortgaged
        columnModel.getColumn(10).setPreferredWidth(120);  // landAreaSqm
        columnModel.getColumn(11).setPreferredWidth(100);  // floorAreaSqm
        columnModel.getColumn(12).setPreferredWidth(100);  // ageOfHouse
        columnModel.getColumn(13).setPreferredWidth(150);  // totalFloorAreaSqm
        columnModel.getColumn(14).setPreferredWidth(150);  // isOffsiteCollateral
        columnModel.getColumn(15).setPreferredWidth(220);  // offsiteCollateralReason
        columnModel.getColumn(16).setPreferredWidth(150);  // housingAccountNo
        ...
        try {
            ...
            CollateralService collateralService = new CollateralService(conn);
            List<Collateral> apps = collateralService.getCollaterals();
            for (Collateral app : apps) {
                model.addRow(new Object[]{
                    app.getIntTctOctCctNo(),
                    app.getStrPrimaryPropertyLocation(),
                    app.getEnumPropertyType(),
                    app.getStrDeveloperTitleHolder(),
                    app.getEnumDescriptionOfImprovements(),
                    app.getStrTaxDeclarationNo(),
                    app.getStrLotUnitNo(),
                    app.getStrBlockBuildingNo(),
                    app.getIntNumberOfStoreys(),
                    app.isBoolIsPropertyMortgaged(),
                    app.getBdLandAreaSqm(),
                    app.getBdLandAreaSqm(),
                    app.getIntAgeOfHouse(),
                    app.getBdTotalFloorAreaSqm(),
                    app.isBoolIsOffsiteCollateral(),
                    app.getStrOffsiteCollateralReason(),
                    app.getStrHousingAccountNo()
                });
            }
        } catch (SQLException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error loading collaterals: " + e.getMessage());
        } catch (Exception e) {
            e.printStackTrace();
