...
import com.mycompany.pagibigapplication.services.RealEstateService;
...
public class RealEstatePage extends javax.swing.JFrame {
    ...
    public RealEstatePage(AuthService authService) {
    ...
    private void addCustomComponents() {
        ...
        JLabel applicationLabel = new JLabel("Real State");
        ...
        // table for data
        String[] columns = {
            "realEstateId", "realEstateLocation", "realEstateType", "housingAccountNo", 
            "acquisitionCost", "marketValue", "mortgageBalance", "rentalIncome"
        };
        ...
        columnModel.getColumn(0).setPreferredWidth(120);   // realEstateId
        columnModel.getColumn(1).setPreferredWidth(180);   // realEstateLocation
        columnModel.getColumn(2).setPreferredWidth(150);   // realEstateType
        columnModel.getColumn(3).setPreferredWidth(150);   // housingAccountNo
        columnModel.getColumn(4).setPreferredWidth(120);   // acquisitionCost
        columnModel.getColumn(5).setPreferredWidth(100);   // marketValue
        columnModel.getColumn(6).setPreferredWidth(100);   // mortgageBalance
        columnModel.getColumn(7).setPreferredWidth(150);   // rentalIncome
        ...
        try {
            ...
            RealEstateService realStateService = new RealEstateService(conn);
            List<RealEstate> apps = realStateService.getRealEstates();
            for (RealEstate app : apps) {
                model.addRow(new Object[]{
                    app.getStrRealEstateId(),
                    app.getStrRealEstateLocation(),
                    app.getEnumRealEstateType(),
                    app.getStrHousingAccountNo(),
                    app.getBdAcquisitionCost(),
                    app.getBdMarketValue(),
                    app.getBdMortgageBalance(),
                    app.getBdRentalIncome(),
                });
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RealEstatePage(new AuthService()).setVisible(true);
            }
        });
    }
