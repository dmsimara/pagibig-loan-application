...
public class EmployerPage extends javax.swing.JFrame {
    ...
    public EmployerPage(AuthService authService) {
    ...
    private void addCustomComponents() {
        ...
        JLabel applicationLabel = new JLabel("Employer");
        ...
        // table for data
        String[] columns = {
            "employerId", "employerPhoneDirect", "employerPhoneTrunk", "employerEmail", 
            "employerName", "employerAddress", "industry", "preferredContactTime"
        };
        ...
        columnModel.getColumn(0).setPreferredWidth(120);   // employerId
        columnModel.getColumn(1).setPreferredWidth(150);   // employerPhoneDirect
        columnModel.getColumn(2).setPreferredWidth(150);   // employerPhoneTrunk
        columnModel.getColumn(3).setPreferredWidth(200);   // employerEmail
        columnModel.getColumn(4).setPreferredWidth(180);   // employerName
        columnModel.getColumn(5).setPreferredWidth(200);   // employerAddress
        columnModel.getColumn(6).setPreferredWidth(150);   // industry
        columnModel.getColumn(7).setPreferredWidth(150);   // preferredContactTime
        ...
        try {
            ...
            List<Employer> apps = employerService.getEmployers();
            for (Employer app : apps) {
                model.addRow(new Object[]{
                    app.getEmployerId(),
                    app.getEmployerPhoneDirect(),
                    app.getEmployerPhoneTrunk(),
                    app.getEmployerEmail(),
                    app.getEmployerName(),
                    app.getEmployerAddress(),
                    app.getIndustry(),
                    app.getPreferredContactTime()
                });
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployerPage(new AuthService()).setVisible(true);
            }
        });
    }
